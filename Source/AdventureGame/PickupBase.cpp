...
void APickupBase::OnSphereBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (Character != nullptr)
	{
		...
		GEngine->AddOnScreenDebugMessage(-1, 3, FColor::Cyan, OtherActor ? OtherActor->GetClass()->GetName() : TEXT("OtherActor=null"));
		GEngine->AddOnScreenDebugMessage(-1, 3, FColor::Cyan, Character ? TEXT("Cast OK") : TEXT("Cast FAIL"));
	}
